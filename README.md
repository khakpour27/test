...
- **Amenities along the route** (🍦 button) — toggle **gelato 🍦, water taps 🚰, toilets 🚻,
  cafés/bars ☕ and bike shops/repair 🔧**, found within ~400 m of the path from live OpenStreetMap
  data, each with a count and directions link. The nav card also shows the **nearest water tap and
  toilet distance** live as you ride.
